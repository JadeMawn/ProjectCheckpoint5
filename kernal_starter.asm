...
_syscallStart_:
    ...
    addi $k1, $0, 14
    beq $v0, $k1, _syscall14 #jump to syscall 15 PLAY SPEAKER
    addi $k1, $0, 15
    beq $v0, $k1, _syscall15 #jump to syscall 15 SET SPEAKER
    addi $k1, $0, 16
...
#set buzzer
_syscall14:
    sw $a0, -208($0)         #0xFFFFFF30 = Play Noise
    jr $k0
...
_syscall15:
    ...
    sw $a2, -212($0)         #0xFFFFFF2C = Choose Buzzer
    jr $k0
